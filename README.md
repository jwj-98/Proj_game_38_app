...
<br/>
+)Json과같은 구조 사용없이 프로젝트이기 때문에 거의 모든통신을 수동으로,각 데이터를 세미콜론 단위로 구분하는  get방식과 유사한 방식을 사용해 통신합니다.(socket & http-post method)<br/>
...
##### 　DB
##### 　　　[1. 테이블 설계](#목차)
##### 　　　(https://user-images.githubusercontent.com/65906245/208213309-6b704001-a5ac-4cef-b867-cec3229714e9.PNG)
##### 　JSP
##### 　　　[1. Jsp 구성](#목차)
